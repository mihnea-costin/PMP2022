...
# distributia teoretica pentru distributia normala
x_norm = np.linspace(-4, 4, 1000)
pdf_norm = norm.pdf(x_norm, 0, 1)

# distributia teoretica pentru distributia exponentiala
...
mean_norm_theoretical = norm.mean(0, 1)
var_norm_theoretical = norm.var(0, 1)

# calculam media si dispersia teoretice pentru distributia exponențiala
mean_exp_theoretical = expon.mean(0, 1)
var_exp_theoretical = expon.var(0, 1)
